...
def doScoutingMuon2024(process):
    process.nanoTableTaskCommon.remove(muonScoutingTable)
    process.nanoTableTaskCommon.remove(displacedvertexScoutingTable)

    process.nanoTableTaskCommon.add(muonVtxScoutingTable, displacedvertexVtxScoutingTable, muonNoVtxScoutingTable, displacedvertexNoVtxScoutingTable)
