...
#muonScoutingTableTask_2024 = cms.Task(muonVtxScoutingTable,muonNoVtxScoutingTable)
#displacedvertexScoutingTableTask_2024 = cms.Task(displacedvertexVtxScoutingTable,displacedvertexNoVtxScoutingTable)
run3_scouting_nanoAOD_2024.toReplaceWith(muonScoutingTableTask, cms.Task(muonVtxScoutingTable, muonNoVtxScoutingTable))\
