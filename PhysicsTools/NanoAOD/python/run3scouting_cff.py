...
scoutingFatPFJetReclusterParticleNetTagExtensionTable = cms.EDProducer("SimplePFJetFlatTableProducer",
    src = cms.InputTag("scoutingFatPFJetRecluster"),
    name = cms.string("ScoutingFatPFJetRecluster"),
    cut = cms.string(""),
    singleton = cms.bool(False),
...
scoutingFatPFJetReclusterSoftDropMassExtensionTable = cms.EDProducer("SimplePFJetFlatTableProducer",
    src = cms.InputTag("scoutingFatPFJetRecluster"),
    name = cms.string("ScoutingFatPFJetRecluster"),
    cut = cms.string(""),
    singleton = cms.bool(False),
...
scoutingFatPFJetReclusterParticleNetMassExtensionTable = cms.EDProducer("SimplePFJetFlatTableProducer",
    src = cms.InputTag("scoutingFatPFJetRecluster"),
    name = cms.string("ScoutingFatPFJetRecluster"),
    cut = cms.string(""),
    singleton = cms.bool(False),
...
scoutingFatPFJetReclusterJetSubstructureVariableExtensionTable = cms.EDProducer("SimplePFJetFlatTableProducer",
    src = cms.InputTag("scoutingFatPFJetRecluster"),
    name = cms.string("ScoutingFatPFJetRecluster"),
    cut = cms.string(""),
    singleton = cms.bool(False),
